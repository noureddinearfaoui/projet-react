...
function FormSearchLivre({livres,setLivres,toast,fetchLivres,findLivreById}){
        ...
        <div className="FormSearchLivre row">
                ...
                <div className="inputSearch  col-lg-3 col-md-3 col-sm-12" >
                            <input type="text"  placeholder="search"  className="form-control"
                             name="inputSearch" onInput={e => setInputSearch(e.target.value)} 
                             />
                </div>
                             <div className="col-lg-3 col-md-3 col-sm-12 ">
                                  <button id="btnshow" className="btn btn-danger" onClick={search}>
                                      <IoMdSearch />
                                  </button>
                             </div>
