                             ...
                             <div className="card-header ">
                                    <ul className="nav nav-tabs card-header-tabs">
                                                <li className="nav-item">
                                                      <div className="nav-link active" href="#">Photo</div>
                                                </li>
      
                                    </ul>
                             </div>
                             <div className="card-body">
                                    <div className="card-title">{showProgress
                                    ...
                                    <div className="card-text">
                                      ...
                                      <div className="btns">
                                                <button className="btn btn-lg btn-primary btnMargin" type="submit" 
                                                 onClick={AppliquerImage}>Appliquer</button>
                                                <button className="btn btn-lg btn-danger btnMargin" id="btn" type="submit"
