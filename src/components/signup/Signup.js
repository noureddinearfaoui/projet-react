        ...
        <div className="Signup">
             <div className="login-form-1">
                    ...
                    <div className="form-group">
                            ...
                            {errors.nom && <span className="text-danger text-error">votre nom est invalide </span>}
                        </div>
                        <div className="form-group">
                            <input type="text" className="form-control" placeholder="Prenom *" 
                            onInput={e => setPrenom(e.target.value)} name="prenom" 
                             ref={register({ required:true,maxLength:100,minLength:4 })} />
                        {errors.prenom && <span className="text-danger text-error">votre prenom est invalide </span>}
                        </div>
                        <div className="form-group">
                        ...
                        {errors.dateN && <span className="text-danger text-error">la date de naissance est obligatoire </span>}
                        </div>
                        <div className="form-group">
                            <input type="text" className="form-control" placeholder="Tel *" 
                            onInput={e => setTel(e.target.value)} name="tel"  
                            ref={register({ required:true,maxLength:100,minLength:4 })} />
                            {errors.tel && <span className="text-danger text-error">le numero est obligatoire </span>}
                        </div>
                        <div className="form-group">
                            <input type="text" className="form-control" placeholder="Adresse *" 
                            onInput={e => setAdresse(e.target.value)}  name="adresse"  
                            ref={register({ required:true })} />
                        {errors.adresse && <span className="text-danger text-error">l'adresse est obligatoire </span>}
                        </div>
                        ...
                        <div className="form-group">
                            ...
                            ref={register({ required:true })} />
                        {errors.email && <span className="text-danger text-error">l'email est obligatoire </span>}
                        </div>
                        <div className="form-group">
                            <input type="password" className="form-control" placeholder="Password *" 
                            onInput={e => setPassword(e.target.value)}  name="password"  
                            ref={register({ required:true })} />
                            {errors.password && <span className="text-danger text-error">vérifier le mot de passe</span>}
                        </div>
                        <div className="form-group">
                            ...
                            onInput={e => setpasswordConfirm(e.target.value)}  name="pswdconfirm" 
                             ref={register({ required:true })} />
                        {errors.pswdconfirm && <span className="text-danger text-error">vérifier le mot de passe </span>}
                        </div>
