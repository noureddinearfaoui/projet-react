      ...
      <div className="ModalUpdate">
        <Modal show={show} onHide={handleClose}>
          <Modal.Header closeButton>
            <Modal.Title>Modifier livre</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            ...
            <div className="form-group">
              <input
                ...
                placeholder="auteur*"
                name="auteur"
                onInput={(e) => setAuteur(e.target.value)}
                ref={register({ required: true, maxLength: 100, minLength: 3 })}
            ...
            <div className="form-group">
              <input
                ...
                name="nbEx"
                onInput={(e) => setnbExemplaire(e.target.value)}
